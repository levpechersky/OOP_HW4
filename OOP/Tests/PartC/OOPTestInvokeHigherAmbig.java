...
static interface B2 extends A2 {
	@OOPMultipleMethod
	public String foo1(String b);
}
public class B2Impl implements B2 {
	@OOPMultipleMethod
	public String foo1(String b) {
		return "b = " + Integer.toString(b);
	}
}

static interface CC extends B1, B2 { }

public class OOPTestInvokeHigherAmbig {
    ...
    @Test
    public void TestHiddenAmbigWorks() {
    	try {
    		C obj = (C) generator.generateMultipleClass(C.class);
    		Integer a = 8;
    		String  b = "hello";
    		assertEqual(obj.foo1(a), "a = 8");
    		assertEqual(obj.foo1(b), "b = hello");
